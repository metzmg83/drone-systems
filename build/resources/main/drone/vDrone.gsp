...
<div id="page">
        ...
        <div>
            ...
            <ul id="navigation">
                ...
                <li class="menu">
                    ...
                    <ul class="primary">
                        <li>
                            <a href="${createLink(uri:'/drone/Autel')}">AutelRobotics</a>
                        </li>
                        <li>
    ...
    <div id="body">
        <div class="header">
            <div>
                <h1>VideoDrone 4 Channel Quadcoptor</h1>
                <img src ="${resource(dir: 'images', file: 'protocolVideoDrone4ChannelQuadcopter.jpg')}" width="100"/>
                <h2>Description</h2>
                <p>With an on-board camera and included 1GB microSD card, this Protocol VideoDrone 6182-3YB 4-channel remote-controlled quad-copter allows you to capture up to 45 minutes of video footage or snap photos from a different perspective.
                </p>
                <h2>Specs</h2>
                <p>Rechargeable, Integrated Camera
                </p>
                <p>17.3 x 17 x 9 inches</p>
                <p>2.5 pounds</p>
                <p>5 minute flight time</p>
                <h2>$79.99</h2>
            </div>
        </div>
    </div>
